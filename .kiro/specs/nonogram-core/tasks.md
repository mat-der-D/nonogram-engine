...
- [ ] 2.2 (P) Error / ValidationError enum の実装
...
- [ ] 3. (P) Solver トレイトと SolveResult の定義（Task 2 完了後）
...
- [ ] 4. (P) LinePropagator の実装（Task 2 完了後）

- [ ] 4.1 単一ライン制約伝播（solve_line）の実装
...
- [ ] 4.2 全盤面フィックスポイント反復（propagate）の実装
...
- [ ] 5. Backtracker の実装（Task 4 完了後）

- [ ] 5.1 degree ヒューリスティックによるセル選択の実装
...
- [ ] 6. (P) CspSolver の実装（Tasks 3・4・5 完了後）
...
- [ ] 8. (P) ProbingSolver の実装（Tasks 3・4・5 完了後）
