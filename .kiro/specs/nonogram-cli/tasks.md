...
- [ ] 5. (P) convert コマンドを実装する
- [ ] 5.1 引数定義とパラメータ検証を実装する
...
- [ ] 6. (P) grid-to-puzzle コマンドを実装する
- [ ] 6.1 引数定義と入力パース・バリデーションを実装する
...
- [ ] 7. 単体テストを実装する
- [ ] 7.1 (P) grid-to-puzzle の計算・パースロジックをテストする
...
- [ ] 8.2 (P) template・grid-to-puzzle コマンドの統合テストを実装する
